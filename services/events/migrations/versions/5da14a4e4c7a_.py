...
def upgrade():
    ...
    op.create_table('event_meetup_association',
    sa.Column('event_id', postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.create_table('meetup_channel_association',
    sa.Column('meetup_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('channel_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['channel_id'], ['channel.id'], ),
    sa.ForeignKeyConstraint(['meetup_id'], ['meetup.id'], )
    ...
    op.create_table('meetup_topic_association',
    sa.Column('meetup_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('topic_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['meetup_id'], ['meetup.id'], ),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], )
    ...
    op.create_table('video_channel_association',
